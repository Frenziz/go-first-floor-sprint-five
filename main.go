...
func (w Walking) Calories() float64 {
	...
	speedInSec := KmHInMsec * w.meanSpeed()
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedInSec, 2.0)/w.Height*CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
